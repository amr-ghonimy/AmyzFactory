...
namespace AmyzFeed.FeedApi.Helpers
{
   public class Constans
    {
        ...
        public static string aboutFilePath;
        public static string qualityFilePath;
        public static string technicalFilePath;
        public static string responsibiltyFilePath;
        ...
        public static string ArticlesImageFolderPath;

        public static string infoImageFolderPath;


        // Image Response 
        public static string sliderImageResponse= @"Images/Sliders/";
        public static string qualityImageResponse= @"Images/Quality/";
        public static string aboutImageResponse= @"Images/About/";
        public static string responsibiltyImageResponse = @"Images/Responsibility/";
        ...
        public static string articleImageResponse = @"Images/Articles/";
